...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtSearch = findViewById(R.id.input);
        btnSearch = findViewById(R.id.button);
        lblCurrent = findViewById(R.id.current);
        lblmin = findViewById(R.id.min);
        lblmax = findViewById(R.id.max);

        textViewWeather = findViewById(R.id.weather);
        imgWeather = findViewById(R.id.icon_image);

        btnGo = findViewById(R.id.go_map);
